...
export const downloadAndDecrypt = async (
  ...
  // console.log('downloadAndDecrypt', blobIds);
  // console.log('sessionKey', sessionKey);
  // console.log('suiClient', suiClient);
  // console.log('sealClient', sealClient);
  // console.log('moveCallConstructor', moveCallConstructor);
  // console.log('setError', setError);
  // console.log('setDecryptedFileUrls', setDecryptedFileUrls);
  // console.log('setIsDialogOpen', setIsDialogOpen);
  // console.log('setReloadKey', setReloadKey);
  ...
  for (let i = 0; i < validDownloads.length; i += 10) {
    ...
    try {
      console.log('fetchKeys', ids);
      console.log('txBytes', txBytes);
      console.log('sessionKey', sessionKey.getPersonalMessage());
      console.log("sealClient", await sealClient.getKeyServers());
...
export const getObjectExplorerLink = (id: string): React.ReactElement => {
  console.log('getObjectExplorerLink', id);
