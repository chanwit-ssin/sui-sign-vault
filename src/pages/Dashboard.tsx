...
import { Plus, FileText, CheckCircle, AlertCircle, Loader2 } from 'lucide-react';
    ...
    <div className="p-6">
      ...
      {!isConnected ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-500">Completed Documents</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-500">Draft Documents</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center">
