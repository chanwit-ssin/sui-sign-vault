...
import { ArrowLeft, FileCheck, Upload, CheckCircle, XCircle, Loader2, FileText, Search } from 'lucide-react';
      ...
      <div className="mb-6">
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Verify the authenticity of a document signature using the document file, the signer's Sui wallet address, and the signature.
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {verificationResult.status === "success" ? (
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        if (verificationResult.transactionId) {
                          window.open(`https://explorer.sui.io/txblock/${verificationResult.transactionId}?network=${NETWORK}`, '_blank');
                        }
                      }}
                    >
                      View on Explorer
                ...
                <Alert className="bg-red-50 border-red-200">
                  <AlertDescription className="text-red-700">
                    The signature could not be verified. Please check the document, wallet address, and signature and try again.
                  </AlertDescription>
                </Alert>
              )}
            </CardContent>
