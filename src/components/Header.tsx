            ...
            <nav className="hidden md:ml-8 md:flex space-x-8">
              {account && (
                <>
                  ...
                  <Link
                    to="/documents"
                    className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${location.pathname.includes("/documents")
                        ? "border-sui-teal text-gray-900"
                        : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                      }`}
                  >
                  ...
                  <Link
                    to="/verify"
                    className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${location.pathname.includes("/verify")
                        ? "border-sui-teal text-gray-900"
                        : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                      }`}
                  >
